...
describe('My Profile Update Profile', () => {
  it('Updates Profile', () => {
    ...
    cy.get('[data-testid="update-profile-firstName"]')
      .type('john');
    cy.get('[data-testid="update-profile-lastName"]')
      .type('doe');
    cy.get('[data-testid="update-profile-country"]')
      .select('japan');
    
    cy.get('[data-testid="update-profile-role"]')
      .select('Decision Maker');
    cy.get('[data-testid="update-profile-org"]')
      .select('HRT - Hellenic Rescue Team');
      
    

    cy.get('[data-testid="updateProfileButton"]')
      .click();
    
    cy.get('[data-testid="updateProfilePasswordBtn"]')
      .click();
    cy.get('[data-testid="old_password"]')
      .type('john');
    cy.get('[data-testid="new_password"]')
      .type('doe');
    cy.get('[data-testid="confirm_password"]')
      .select('japan');
    cy.get('[data-testid="changePasswordUpdateBtn"]')
      .click();
  });
});