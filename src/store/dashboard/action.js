...
export const getStats = params => async dispatch => {
  ...
  } else return dispatch(getStatsFail(response.error));
};
...
export const getWeatherStats = params => async dispatch => {
  ...
  } else return dispatch(getWeatherStatsFail(response.error));
};
...
export const getWeatherVariables = params => async dispatch => {
  ...
  } else return dispatch(getWeatherVariablesFail(response.error));
};
