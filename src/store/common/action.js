...
export const getConfig = () => async dispatch => {
  ...
  } else return dispatch(getConfigFail(response.data));
};
...
export const getOrgList = () => async dispatch => {
  ...
  } else return dispatch(getOrgListFail(response.data));
};
...
export const getRoleList = () => async dispatch => {
  ...
  } else return dispatch(getRoleListFail(response.data));
};
...
export const getAllAreas = () => async dispatch => {
  ...
  if (response.status === 200) return dispatch(getAoiSuccess(response.data));
