...
const userReducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.SET_AOI_SUCCESS:
      return setAoiSuccess(state, action);
    case actionTypes.SET_AOI_FAIL:
      return setAoiFail(state, action);
    case actionTypes.MP_GET_SUCCESS:
      return getInfoSuccess(state, action);
    case actionTypes.MP_GET_FAIL:
      return getInfoFail(state, action);
    case actionTypes.MP_UPDATE_SUCCESS:
      return updateInfoSuccess(state, action);
    case actionTypes.MP_UPDATE_FAIL:
      return updateInfoFail(state, action);
    case actionTypes.MP_FILEUPLOAD_SUCCESS:
      return uploadFileSuccess(state, action);
    case actionTypes.MP_FILEUPLOAD_FAIL:
      return uploadFileFailed(state, action);
    case actionTypes.MP_RESETPSW_SUCCESS:
      return resetPswSuccess(state, action);
    case actionTypes.MP_RESETPSW_FAIL:
      return resetPswFail(state, action);
    case actionTypes.MP_DELETE_SUCCESS:
      return deleteAccSuccess(state, action);
    case actionTypes.MP_DELETE_FAIL:
      return deleteAccFail(state, action);
    case actionTypes.MP_RESET_STATUS:
