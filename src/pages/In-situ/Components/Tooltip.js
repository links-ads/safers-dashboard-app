...
const Tooltip = ({ object = [] }) => (
  <Popup
    longitude={object[0].geometry.coordinates[0]}
    latitude={object[0].geometry.coordinates[1]}
    offsetLeft={15}
    ...
    <div>
      {object.map(({properties: { id, direction, last_update, description }}) => (
